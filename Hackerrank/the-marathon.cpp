...
class Graph{
    int V;   
    list<int> *adj;   
    void SCCUtil(int u, int disc[], int low[],stack<int> *st, bool stackMember[],vector<map<int,bool> > &vec);
public:
    Graph(int V); 
...
void Graph::SCCUtil(int u, int disc[], int low[], stack<int> *st,bool stackMember[],vector<map<int,bool> > &vec){
